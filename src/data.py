...
class Pdfs_dir_loader:
    ...
    def vector_db_add(self, chunks, CHROMA_PATH):
        db = Chroma(persist_directory = CHROMA_PATH, embedding_function = self._embedding_func())
...
if __name__ == '__main__':
    ...
    print(type(init_pdf_loader.all_docs[0]))
